const media = {
  ...
  "autopilot.panel.newJob": "Tạo tác vụ mới",
  ...
  "autopilot.panel.splitModeAuto": "Tự động theo nhà cung cấp",
  "autopilot.panel.splitModeHint": "Tự động: Vbee đọc cả kịch bản một lần, các nhà cung cấp khác đọc theo dòng rồi ghép lại. Chọn tay để ép cách đọc cho mọi nhà cung cấp.",
  ...
  "autopilot.panel.jobStarted": "Bắt đầu",
  "autopilot.panel.jobFinished": "Kết thúc",
  "autopilot.panel.jobElapsed": "Tổng",
  "autopilot.panel.jobs": "Tác vụ",
  "autopilot.panel.noJobs": "Chưa có tác vụ nào.",
  ...
  "autopilot.panel.importAudio": "Nhập tệp giọng đọc",
  ...
  "autopilot.card.renderingVideo": "Đang tạo video",
  "autopilot.card.videoFailed": "Lỗi video",
  "autopilot.card.videoFallback": "Ảnh tĩnh (video lỗi)",
  "autopilot.card.errorDetail": "Chi tiết lỗi",
