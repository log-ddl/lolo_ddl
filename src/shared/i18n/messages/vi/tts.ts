const tts = {
  ...
  "tts.batch.title": "Đọc hàng loạt theo thư mục",
  "tts.batch.description": "Chọn một thư mục: app quét mọi file .txt kể cả trong thư mục con, đọc lần lượt và lưu audio ngay cạnh file .txt.",
  "tts.batch.pickFolder": "Chọn thư mục",
  "tts.batch.pickFolderTitle": "Chọn thư mục chứa file .txt",
  "tts.batch.openFolder": "Mở thư mục",
  "tts.batch.rescan": "Quét lại thư mục",
  "tts.batch.clearFolder": "Bỏ chọn thư mục",
  "tts.batch.scanning": "Đang quét thư mục...",
  "tts.batch.empty": "Thư mục này không có file .txt nào.",
  "tts.batch.truncated": "Chỉ nạp {count} file đầu tiên.",
  "tts.batch.summary": "{total} file .txt • {pending} sẽ đọc • {skipped} đã có audio nên bỏ qua",
  "tts.batch.chars": "{count} ký tự",
  "tts.batch.progress": "Đã xử lý {done}/{total}",
  "tts.batch.errorCount": "{count} lỗi",
  "tts.batch.start": "Đọc {count} file",
  "tts.batch.stop": "Dừng",
  "tts.batch.status.pending": "Chờ",
  "tts.batch.status.running": "Đang đọc",
  "tts.batch.status.done": "Xong",
  "tts.batch.status.skipped": "Đã có audio",
  "tts.batch.status.error": "Lỗi",
  "tts.batch.nothingToDo": "Không còn file nào cần đọc",
  "tts.batch.emptyFile": "File không có nội dung",
  "tts.batch.scanFailed": "Không thể quét thư mục",
  "tts.batch.saveFailed": "Không lưu được audio vào thư mục nguồn",
  "tts.batch.modelNotReady": "Model chưa sẵn sàng, hãy tải model trước khi đọc hàng loạt",
  "tts.batch.finished": "Đọc hàng loạt xong: {done} thành công, {failed} lỗi",
  "tts.batch.stopped": "Đã dừng đọc hàng loạt: {done} thành công, {failed} lỗi",
  "tts.batch.stoppedAfterErrors": "Đã dừng vì 3 file liên tiếp bị lỗi: {done} thành công, {failed} lỗi",
  "tts.batch.onlineHint": "Engine online có hạn mức theo ngày: batch nghỉ giữa các file và tự dừng nếu 3 file liên tiếp lỗi.",
