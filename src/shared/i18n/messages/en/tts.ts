const tts = {
  ...
  "tts.batch.title": "Batch read a folder",
  "tts.batch.description": "Pick a folder: the app scans every .txt file including subfolders, reads them one by one and saves each audio next to its .txt file.",
  "tts.batch.pickFolder": "Choose folder",
  "tts.batch.pickFolderTitle": "Choose the folder with .txt files",
  "tts.batch.openFolder": "Open folder",
  "tts.batch.rescan": "Rescan folder",
  "tts.batch.clearFolder": "Clear folder",
  "tts.batch.scanning": "Scanning folder...",
  "tts.batch.empty": "This folder has no .txt files.",
  "tts.batch.truncated": "Only the first {count} files were loaded.",
  "tts.batch.summary": "{total} .txt files • {pending} to read • {skipped} skipped (audio exists)",
  "tts.batch.chars": "{count} characters",
  "tts.batch.progress": "Processed {done}/{total}",
  "tts.batch.errorCount": "{count} failed",
  "tts.batch.start": "Read {count} files",
  "tts.batch.stop": "Stop",
  "tts.batch.status.pending": "Queued",
  "tts.batch.status.running": "Reading",
  "tts.batch.status.done": "Done",
  "tts.batch.status.skipped": "Audio exists",
  "tts.batch.status.error": "Failed",
  "tts.batch.nothingToDo": "No file left to read",
  "tts.batch.emptyFile": "File has no content",
  "tts.batch.scanFailed": "Could not scan the folder",
  "tts.batch.saveFailed": "Could not save the audio into the source folder",
  "tts.batch.modelNotReady": "Model is not ready; download it before batch reading",
  "tts.batch.finished": "Batch finished: {done} succeeded, {failed} failed",
  "tts.batch.stopped": "Batch stopped: {done} succeeded, {failed} failed",
  "tts.batch.stoppedAfterErrors": "Stopped after 3 consecutive failures: {done} succeeded, {failed} failed",
  "tts.batch.onlineHint": "Online engines have daily quotas: the batch pauses between files and stops itself after 3 consecutive failures.",
