const media = {
  ...
  "autopilot.panel.splitModeAuto": "Auto (per provider)",
  "autopilot.panel.splitModeHint": "Auto: Vbee reads the whole script in one request, every other provider reads line by line and joins the parts. Pick a mode to force it for any provider.",
  ...
  "autopilot.panel.jobStarted": "Started",
  "autopilot.panel.jobFinished": "Finished",
  "autopilot.panel.jobElapsed": "Total",
  ...
  "autopilot.card.videoFallback": "Still (video failed)",
  "autopilot.card.errorDetail": "Error detail",
