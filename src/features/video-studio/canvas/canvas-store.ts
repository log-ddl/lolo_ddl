      ...
      return {
        ...
        updateNode: (spaceId, nodeId, patch) => {
          ...
          withSpace(spaceId, (space) => {
            ...
            const affectsOutput = changed.some((key) => ['aiAdapter', 'textOutput', 'imageEdit', 'prompt', 'promptIsFinal', 'refs', 'model', 'videoDuration', 'videoMode', 'aspectRatio', 'items', 'valueType', 'selectedValue', 'selectedItem', 'output'].includes(key));
