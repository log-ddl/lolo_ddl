    ...
    <>
        ...
        <div className="space-y-1">
          ...
          {showPromptDetails ? (
                  ...
                  <div className="space-y-1">
                    ...
                    {scene.imagePrompt && (
                      <div className="rounded border border-blue-500/15 bg-background/60 p-2">
                        <div className="mb-1 text-[10px] font-medium text-blue-600 dark:text-blue-400">Prompt gửi đi</div>
                        <pre className="max-h-32 whitespace-pre-wrap overflow-y-auto text-[10px] leading-relaxed text-muted-foreground">
                  ...
                  <div className="space-y-1">
                    ...
                    {scene.videoPrompt && (
                      <div className="rounded border border-green-500/15 bg-background/60 p-2">
                        <div className="mb-1 text-[10px] font-medium text-green-600 dark:text-green-400">Prompt gửi đi</div>
                        <pre className="max-h-32 whitespace-pre-wrap overflow-y-auto text-[10px] leading-relaxed text-muted-foreground">
            ...
            <div
              className="space-y-0.5 rounded-md border border-transparent bg-muted/20 p-1.5 transition-colors hover:border-muted hover:bg-muted/40 cursor-pointer"
              onClick={() => setShowPromptDetails(true)}
            >
              {!isRefToVideo && <p className="text-[9px] truncate flex items-center gap-1">
