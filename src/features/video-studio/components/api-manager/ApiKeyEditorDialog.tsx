  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle>{t("apiDialog.editProvider")} {providerName} Keys</DialogTitle>
        </DialogHeader>
                      ...
                      {key.editing ? (
                        ...
                        <TooltipProvider>
                          <Tooltip>
                            ...
                            <TooltipContent>{t("characters.save")}</TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
                      ) : (
                        ...
                        <>
                          ...
                          <TooltipProvider>
                            <Tooltip>
                              ...
                              <TooltipContent>Test Key</TooltipContent>
                            </Tooltip>
                          </TooltipProvider>
                  ...
                  {hasTestedKeys && hasInvalidKeys && (
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent>Delete Invalid Keys</TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
                  )}
                  ...
                  {onTestKey && (
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent>Test All Keys</TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
                  )}
                </>
