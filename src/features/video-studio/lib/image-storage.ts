 ...
 * Handles saving and loading images via Electron IPC (app) or IndexedDB (browser/localhost).
 */
...
export async function saveImageToLocal(
  ...
  // Browser fallback: save to IndexedDB instead of filesystem
  if (!isElectron()) {
