...
import { getStyleTokens as getStyleTokensFromVisualStyles } from '@/features/video-studio/lib/constants/visual-styles';
 ...
 * Use the shared visual-styles library and stay compatible with legacy ids.
 */
