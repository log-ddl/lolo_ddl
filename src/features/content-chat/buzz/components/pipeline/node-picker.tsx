  ...
  return (
    <aside className="flex w-80 shrink-0 flex-col border-l border-border bg-card shadow-[-8px_0_24px_rgba(0,0,0,0.05)]">
      <div className="flex items-start justify-between gap-3 px-4 pb-3 pt-4">
        <div><h2 className="text-sm font-semibold">Thêm gì vào workflow?</h2><p className="mt-1 text-[11px] text-muted-foreground">Chọn một node rồi nối dữ liệu trên canvas.</p></div>
